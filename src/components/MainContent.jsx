            ...
            {featuredSong && (
              <div className="mb-8">
                <div
                  ...
                  className={`relative backdrop-blur-xl overflow-hidden cursor-pointer group hover:scale-[1.02] hover:-translate-y-1 transition-all duration-200 border md:rounded-3xl featured-card-mobile ${isFeaturedTransitioning ? 'opacity-0' : 'opacity-100'}`}
                >
                  {/* Mobile-specific styles override */}
                  <style>{`
                    @media (max-width: 767px) {
                      .featured-card-mobile {
                        background: linear-gradient(145deg, #14110E 0%, #1B1713 45%, #0B0B0C 100%) !important;
                  ...
                  `}</style>
                  {/* Mobile Layout */}
                  <div className="md:hidden flex flex-col gap-[18px]" style={{ padding: '22px' }}>
                    {/* Label */}
                    <p className="text-xs font-semibold tracking-wider" style={{ color: isLightMode ? '#6E6E73' : 'rgba(255, 255, 255, 0.55)', letterSpacing: '0.18em', fontSize: '12px' }}>FEATURED ALBUM</p>
                    
                    {/* Cover */}
                    <div className="flex-shrink-0 relative" style={{ width: '150px', height: '150px', alignSelf: 'center' }}>
                      {imageErrors[featuredSong.id] ? (
                        <div style={{ backgroundColor: isLightMode ? '#E5E7EB' : '#121212' }} className="w-full h-full rounded-[24px] flex items-center justify-center shadow-xl">
                        ...
                        <img
                          ...
                          className="w-full h-full rounded-[24px] object-cover shadow-xl transition-all duration-300 group-hover:scale-105"
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <h2 className="font-bold truncate" style={{ color: isLightMode ? '#111111' : '#FFFFFF', fontSize: '26px', lineHeight: '1.1', textAlign: 'center', maxWidth: '100%' }}>{featuredSong.title}</h2>
                      {featuredSong.artist && featuredSong.artist !== 'Unknown Artist' && (
                        <p className="text-sm truncate" style={{ color: isLightMode ? '#6E6E73' : '#A1A1AA', textAlign: 'center' }}>{featuredSong.artist}</p>
                      )}
                      <button
                        onClick={(e) => {
                          e.stopPropagation()
                        ...
                        className="rounded-full font-semibold transition-all duration-200 hover:scale-105"
                        style={{
                          backgroundColor: isLightMode ? '#FFFFFF' : 'rgba(255, 255, 255, 0.92)',
                          color: '#000000',
                          boxShadow: isLightMode ? '0 10px 28px rgba(0, 0, 0, 0.15)' : '0 10px 28px rgba(0, 0, 0, 0.25)',
                          padding: '12px 26px',
                          fontSize: '16px',
                          fontWeight: '700',
                          alignSelf: 'center'
